    ...
    return (
        <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="flex justify-center">
                <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-8 max-w-2xl w-full hover:border-blue-500/50 transition-all">
                    ...
                    <div className="space-y-6 text-slate-300 leading-relaxed text-center">
                        <p>
                            <span className="font-semibold text-blue-400">Prompt Sanitizer</span> is a secure demonstration tool designed to prevent data leaks by scrubbing sensitive information from your text.
                        </p>
                        <p>
